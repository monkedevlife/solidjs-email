...
export default defineConfig({
  ...
  resolve: {
    ...
    alias: {
      ...
      '@solidjs-email/tailwind': resolve(
        __dirname,
        'packages/tailwind/src/index.ts',
      ),
      '@solidjs-email/components': resolve(
        __dirname,
        'packages/components/src/index.ts',
      ),
      '@solidjs-email/button': resolve(
        __dirname,
        'packages/button/src/index.ts',
      ),
      '@solidjs-email/code-inline': resolve(
        __dirname,
        'packages/code-inline/src/index.ts',
      ),
      '@solidjs-email/code-block': resolve(
        __dirname,
        'packages/code-block/src/index.ts',
      ),
      '@solidjs-email/container': resolve(
        __dirname,
        'packages/container/src/index.ts',
      ),
      '@solidjs-email/section': resolve(
        __dirname,
        'packages/section/src/index.ts',
      ),
      '@solidjs-email/row': resolve(__dirname, 'packages/row/src/index.ts'),
      '@solidjs-email/column': resolve(
        __dirname,
